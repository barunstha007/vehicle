      ...
      {numSelected > 0 ? (
        <React.Fragment>
          <button
            ...
            onClick={() => completeServicing(selected, setSelected)}
          >
            Completed
          </button>
          <button
...
function EnhancedTable(props) {
  ...
  const emptyRows =
    rowsPerPage -
    Math.min(rowsPerPage, props.acceptedBooking.length - page * rowsPerPage);
    ...
    <div className={classes.root}>
      ...
      <Paper className={classes.paper}>
        <EnhancedTableToolbar
          ...
          reQueue={props.reQueue}
          completeServicing={props.completeServicing}
        />
