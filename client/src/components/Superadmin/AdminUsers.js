    ...
    const getadminlist = props.adminlist.map((admin, index) => {
        return (
            <tr key={index}>
                ...
                <td className="pt-3-half" name="name">{admin.name}</td>
                ...
                <td>
                    <span className="table-remove">
                        ...
                        <button
                            type="button"
                            className="btn btn-primary btn-rounded btn-sm my-0 mx-1"
                            onClick={() => updateHandler(admin)}><MdModeEdit /></button>

                        <button
                            type="button"
                            className="btn btn-danger btn-rounded btn-sm my-0"
                            onClick={() => deleteHandler(admin)}><MdDelete /></button>
                    </span>
                </td>
            </tr>
        )
    ...
    return (
        <div className="card">
            ...
            <span className="badge badge-info">
                <h3 className="card-header text-center font-weight-bold text-uppercase py-4">Admin</h3>
            </span>
